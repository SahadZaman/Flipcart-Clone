    ...
    return (
        ...
        <Component>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />Sign up for Flipcart Pay Later and get Flipkart Gift Card worth₹100* Know More</Typography>
                <Typography><StyledBadge />By 2 items save 5%;Buy 3 or more save 10% T&C</Typography>
            ...
            <Table>
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell >
                            <Box component='span' style={{color:"#2874f0"}}>SuperComponent</Box>
                    ...
                    <ColumnText>
                        <TableCell colSpan={2}>
                            <img src={adURL} style={{width:390}} alt="urlAdd" />
                        </TableCell>
                    </ColumnText>
                    <ColumnText >
